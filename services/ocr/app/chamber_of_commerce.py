"""Libyan Chamber of Commerce Certificate (شهادة الغرفة التجارية) field
...
_LABEL_KEYWORDS = {
    ...
    "membership_number": ["رقم العضوية", "العضوية"],
    "chamber_name": ["الغرفة التجارية", "الغرفة"],
    "expiry_date": ["تاريخ الانتهاء", "الانتهاء"],
}


def extract_chamber_of_commerce_fields(
